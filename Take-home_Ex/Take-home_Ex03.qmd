...
1\. Initial exploratory analysis (primarily to understand the dataset structure)

2\. Prototype: provides the various visualisation options and a storyboard for the **Network Insights Module.**
