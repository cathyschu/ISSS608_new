...
Take-home exercise 4 is to showcase the prototyping for one of modules in the Visual Analytics group project - Track Singapore Public Dollars! Taxpayers would want to know where and how the govenment spend money on developing the country. The Singapore government procurement data is publicly available for everyone who would like to study it. However, with more than over 6K entries of data per year (on average), it is difficult for the public to decypher any insights. A visualisation tool we are developing aims to democratise the dataset to the public for this purpose. 

This assignment is divided into 2 segmens (webpages).
1. Initial exploratory analysis (this is mainly to understand the structure of the dataset)
2. Prototype: provides the various visualisation options that users may use and the storyboard for the **Network Insights Module.**
